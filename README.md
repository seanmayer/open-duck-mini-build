...
Phase 1 is focused on getting the workshop ready: core 3D printing tools, fasteners, soldering equipment, wire prep, and basic electronics consumables.

The next milestone is Phase 2: sourcing the actual robot hardware such as servos, Raspberry Pi, IMU, servo controller, batteries, bearings, and wiring.
