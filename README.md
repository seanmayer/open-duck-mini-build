...
Printed so far: PLA feet, leg spacers, knee-to-ankle sheets, roll motor mounts, roll-to-pitch parts, trunk top/bottom pieces, neck sheets, the full required head print group, left/right cache body pieces, and the body front panel. The PLA feet have been dry-fitted without the optional TPU bottoms.
